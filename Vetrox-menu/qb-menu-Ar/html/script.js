...
const openMenu = (data = null) => {
    ...
    data.forEach((item, index) => {
        if (!item.hidden) {
            ...
            html += getButtonRender(header, index, isMenuHeader, isDisabled, icon, progressbar);
...
const getButtonRender = (header = null, id, isMenuHeader, isDisabled, icon, progressbar) => {
    if (icon !== undefined) {
        return `
